...
const SNOW_COLORS: Record<string, boolean> = {
  winter: true,
};

function BuildingSprite({ building, season }: { building: Building; season: Season }) {
  const hasSnow = SNOW_COLORS[season] ?? false;
    ...
    case "hut":
      return (
        <div className="relative flex flex-col items-center">
          ...
          />
          {/* Walls */}
          <div className="w-8 h-6 bg-[#d2a56c] border border-[#a0784a] flex items-end justify-center sm:w-10 sm:h-8">
    ...
    case "farm":
      return (
        <div className="relative flex flex-col items-center">
          ...
          />
          {/* Barn */}
          <div className="w-10 h-7 bg-[#c0392b] border border-[#962d22] flex items-end justify-center gap-0.5 sm:w-12 sm:h-9">
          ...
          <div className="flex gap-[2px] mt-0.5">
            {[0, 1, 2, 3, 4].map((j) => (
              <div
                ...
                style={{
                  background: hasSnow ? "#c8d0d8" : season === "autumn" ? "#c8a040" : "#4caf50",
                }}
              />
            ))}
          </div>
    ...
    case "lumbermill":
      return (
        <div className="relative flex flex-col items-center">
          ...
          />
          {/* Building */}
          <div className="w-8 h-10 bg-[#6d4c41] border border-[#4e342e] flex flex-col items-center justify-end sm:w-10 sm:h-12">
    ...
    case "market":
      return (
        <div className="relative flex flex-col items-center">
          ...
          {/* Counter */}
          <div className="w-14 h-6 bg-[#d7ccc8] border border-[#a1887f] flex items-center justify-center gap-1 sm:w-16 sm:h-8">
